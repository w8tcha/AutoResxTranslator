namespace AutoResxTranslator
{
    ...
    public class MsTranslateService
    {
        ...
        public static async Task<ResultHolder<string>> TranslateAsync(
            string text,
            string fromLanguage,
            string toLanguage,
            ...
            string region)
        {
            if (fromLanguage.Equals("auto") || fromLanguage.Equals(string.Empty))
            {
                fromLanguage = null;
            }
                ...
                using (var request = new HttpRequestMessage())
                {
                    ...
                    if (response.StatusCode == System.Net.HttpStatusCode.OK)
                    {
                        ...
                        var deserializedOutput =
                            JsonConvert.DeserializeObject<MsTranslationApi.TranslationResult[]>(resultFromMs);
